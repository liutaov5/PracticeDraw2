...
public class Practice14MaskFilterView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // 第二个：INNER
        MaskFilter maskFilter2=new BlurMaskFilter(100,BlurMaskFilter.Blur.INNER);
        paint.setMaskFilter(maskFilter2);
        canvas.drawBitmap(bitmap, bitmap.getWidth() + 200, 50, paint);

        // 第三个：OUTER
        MaskFilter maskFilter3=new BlurMaskFilter(100,BlurMaskFilter.Blur.OUTER);
        paint.setMaskFilter(maskFilter3);
        canvas.drawBitmap(bitmap, 100, bitmap.getHeight() + 100, paint);

        // 第四个：SOLID
        MaskFilter maskFilter4=new BlurMaskFilter(100,BlurMaskFilter.Blur.SOLID);
